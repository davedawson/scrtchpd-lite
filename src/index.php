...
To get started, just start typing!"><?php echo htmlspecialchars($note); ?></textarea>
    ...
    <section class="bb">
          ...
          <div class="s-s g">
            ...
            <div class="m-b" onclick="scrtchpd.rszT('5')">
            ...
            <a href="#" class="t-i r" onclick="scrtchpd.rstT('22')">Reset Size</a>
          </div>
          <div class="s-s g t">
            <label>Adjust Type Style</label>
              <a href="#" id="t-ss" onclick="scrtchpd.fST('sans')">Sans-Serif</a>
              <a href="#" id="t-s" onclick="scrtchpd.fST('serif')">Serif</a>
          </div>
      		<div class="s-s ">
            <label>Details</label>
          ...
          <div class="s-s">
        		<a class="c-n" href="#" onclick="scrtchpd.clP()">Clear Note Pad</a>
          </div>
        </div>
        <div id="b" class="m-b n-d-i h" onclick="scrtchpd.ttT()">
